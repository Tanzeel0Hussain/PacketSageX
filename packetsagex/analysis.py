...
def analyze_capture(
    ...
    *,
    ...
    report: dict[str, object] = {
        ...
        "packet_analysis": build_packet_analysis(packets),
        "top_endpoints": [
            {"endpoint": row["endpoint"], "packets": row["packets"], "bytes": row["bytes"]}
            for row in inventory[:20]
        ],
        "endpoint_inventory": inventory,
        "dns_analytics": intelligence.dns_analytics(),
        "tls_quic_intelligence": intelligence.tls_quic_intelligence(),
