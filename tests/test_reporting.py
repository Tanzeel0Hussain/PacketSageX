...
def test_html_report_has_search_and_intelligence_sections(tmp_path):
    report={'source':'demo.pcap','backend':'live-scapy','interface':'any','packet_count':10,'flow_count':1,'byte_count':2048,'security_findings':[],
    ...
    assert 'example.com' in text and 'Web / HTTPS' in text
